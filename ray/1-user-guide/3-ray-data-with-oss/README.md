...
Build and push it to your image registry, replacing `<your-registry>` with your registry address.
...
docker build -f Dockerfile -t <your-registry>/ray:2.56.1-py312-with-iris .
docker push <your-registry>/ray:2.56.1-py312-with-iris
```
