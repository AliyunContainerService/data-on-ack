...
export const FromAddDropDown = ({
  ...
  useEffect(() => {
    if (form.getFieldValue(fieldCode)) {
      let optionGather = {};
      let msg = {};
      Array.prototype.forEach.call((options || []), ({ name, local_path, pvc_name }) => {
      ...
      form.getFieldValue(fieldCode).forEach(({imgPullSecrets}, index) => {
        msg[imgPullSecrets] = optionGather[imgPullSecrets];
        msg[`${index}_img_secret`]=optionGather[`${index}&img_secret`];
        msg[index]=imgPullSecrets;
      });
