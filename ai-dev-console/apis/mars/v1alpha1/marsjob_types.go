...
import (
	commonv1 "github.com/AliyunContainerService/data-on-ack/ai-dev-console/pkg/job_controller/api/v1"
...
type MarsJob struct {
	...
	Status MarJobStatus `json:"status,omitempty"`
}
