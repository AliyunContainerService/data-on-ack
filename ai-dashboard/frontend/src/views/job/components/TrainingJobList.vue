<template>
  <div>
    ...
    >
      ...
      <el-table-column :label="$t('job.requestGpus')">
        <template slot-scope="scope">
          <span>{{ scope.row.requestGpus }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('job.allocatedGpus')">
        <template slot-scope="scope">
          <span>{{ scope.row.allocatedGpus }}</span>
        </template>
      </el-table-column>
...
<script>
import { fetchTrainingJobList } from '@/api/job'
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      fetchTrainingJobList(this.listQuery).then(response => {
