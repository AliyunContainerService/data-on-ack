    ...
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <el-form-item prop="clientSecret">
        ...
        <el-input
          :key="passwordType"
          ref="clientSecret"
          v-model="loginForm.clientSecret"
          :type="passwordType"
      ...
      <el-button type="primary" style="width:100%;margin-bottom:30px;" @click.native.prevent="handleLogin">使用阿里云RAM账号登录</el-button>
  ...
  data() {
    ...
    return {
      ...
      loginRules: {
        ...
        clientSecret: [{ required: true, trigger: 'blur', type: 'string' }]
      },
